...
<head>
    ...
    <script src="html/library/js/jquery-1.9.1.min.js"></script>
    <script src="html/library/js/bootstrap.bundle.js"></script>
    <script src="html/library/js/bootstrap.js"></script>
    <script src="html/library/js/udepsi.js"></script>
...
<div class="container-fluid">
        ...
        <div class="col-3">
            <div class="row strip">
                ...
                <div class="col-7 udepsi_strip">
                    <a href = "view/index.php" class="mainpagebutton">
    ...
    <div class="row main" style="margin-left=1vw !important">
        <div id="test"class="col-10" style="text-align: center">
            <div class="content-main">
                <div class="course">
                    ...
                    <div class="course-bottom">
                        Par : Un fils de pute
                        <img class="course-link" src="html/img/php.png"/>
                    </div>
                </div>
                <div class="course">
